...
stop_linux() {
  "${SYSTEMCTL_BIN}" stop executor-agent.service executor-broker.service cloudflared.service
  "${SYSTEMCTL_BIN}" disable executor-agent.service executor-broker.service cloudflared.service
