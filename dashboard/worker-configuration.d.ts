/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.typegen.vars` (hash: 0ac92ff1349a41535b7d7838545b6374)
...
interface __BaseEnv_Env {
	...
	DEVICE_RELAY: DurableObjectNamespace<import("./src/index").DeviceRelay>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DeviceRelay";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_AUD" | "ACCESS_TEAM_DOMAIN" | "ENROLLMENT_TOKEN_HASH">> {}
}
