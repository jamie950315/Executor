...
- Browser file reads (normal, empty, paginated) and public pre-first-byte disconnect acceptance remain pending: the owner must unlock with the existing Beta Recovery Key. No key was retrieved, generated, or rotated during this deployment.
